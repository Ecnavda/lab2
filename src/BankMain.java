public class BankMain() {
	...
	public static void main(String[] args) {
		...
		BankAccount testAccount = new BankAccount(1000.0, .06);
		System.out.println(testAccount);

		System.out.println("Testing SetInterestRate method.");
		BankAccount testAccount = new BankAccount();
		...
		System.out.println("Testing MakeDeposit method.");
		...
		System.out.println("Testing MakeWithdrawl method.");
		testAccount.MakeWithdrawl(500.0);
		System.out.println("The balance is: " + testAccount.GetBalance());
		
		System.out.println("Testing the Compound method with the existing balance.");
